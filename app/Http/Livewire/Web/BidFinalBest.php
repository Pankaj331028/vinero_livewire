...
class BidFinalBest extends Component {
	...
	public function mount(Request $request) {
		...
		$this->property_end_date = Carbon::parse($user->property->vms_end_date)->format('D M d,Y');

		// if(isset($request->p)){
		$this->data_time = $request->p;
	...
	public function render() {
		return view('livewire.web.bid-final-best');
	}
	...
	public function updated($name) {
		...
		if ($this->improve == '0' || $this->improve == '3') {
			$this->reset('amount');
		}

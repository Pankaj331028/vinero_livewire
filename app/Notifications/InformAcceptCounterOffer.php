...
class InformAcceptCounterOffer extends Notification {
	...
	public function toArray($notifiable) {
		if (isset($this->notify_user->devices)) {
			foreach ($this->notify_user->devices as $device) {
				$fcmMsg = array(
					'title' => $this->offer->property->vms_property_id . " - Buyer accepted Counter Offer",
					'description' => "Counter offer accepted by buyer - " . $this->offer->buyer_name . '(' . $this->offer->owner->phone_no . ')',
					'vibrate' => 1,
		...
		return [
			'title' => $this->offer->property->vms_property_id . " - Buyer accepted Counter Offer",
			'details' => "Counter offer accepted by buyer - " . $this->offer->buyer_name . '(' . $this->offer->owner->phone_no . ')',
			'notification_type' => 'offer_improve',

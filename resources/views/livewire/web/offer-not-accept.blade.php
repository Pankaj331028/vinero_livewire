                                        ...
                                        <div class="card-box history px-3 py-4">
                                            ...
                                            <div class="white-box mt-2">
                                                <div class="row align-items-center selller-broker">
                                                    <div class="col-md-12">
                                                        <label class="green-label">Your offer was not accepted. The seller encourages you to reevaluate your comparables and submit an improved offer.</label>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-box history @error('improve') is-invalid @enderror">
                                                    <div class="row align-items-center">
                                                        <div class="col-md-12">
                                                            <div class="form__group">
                                                                <div class="form__radio-group">
                                                                    <input type="radio" name="sizeee" wire:model="improve" value="3" id="smallaa" class="form__radio-input" @if($this->control_mode == 0) disabled @endif>
                                                                    <label class="form__label-radio" for="smallaa">
								...
								<div class="continue-transaction">
									<div class="row m-0">
										<div class="col-md-6 text-end electronic-documents">
											<p class="pt-1">I hereby consent to use electronic documents &amp; signatures in connection with the purchase of this property.</p>
										</div>
										<div class="col-md-6 text-center">
											<button class="btn tabs-submit-buttons" type ="submit" wire:click="submitModifyOffer" @if($this->control_mode == 0) disabled @endif>
                                                <label class="px-4">
                                                    SUBMIT
                                                </label>

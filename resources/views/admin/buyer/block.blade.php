...
<x-breadcrumb title="{{$title}}" module="Buyer" link="{{route('buyer')}}"></x-breadcrumb>
<!-- begin:: Content -->
                            ...
                            <div class="kt-portlet">
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h4>{{('Block/Unblock Buyer')}}</h4>
                                    </div>
                                </div>
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right"
                                    action="{{ route('buyer-update-block', $buyer->id) }}" method="post"
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <label class="">OPT :</label><span class="text-sucees"> {{ $buyer->optin_out ?? ''}}</span>
                                            </div>
                                         </div>
                                         <div class="form-group row">
                                            <div class="col-lg-6">
                                                ...
                                                <select class="form-control" name="status" id="status">
                                                    ...
                                                    @if($buyer->status == 0 || $buyer->status == 1 || $buyer->status == 2 )
                                                    <option value="3" {{ $buyer->status == 3 ? 'selected' : '' }}>Block</option>
                                                    @else
                                                    <option value="1" {{ $buyer->status == 1 ? 'selected' : '' }}>Unblock</option>
                                                    @endif
                                                </select>
                                            </div>
                                            <div class="col-lg-6">
                                                ...
                                                <textarea class="form-control" name="block_comment"
                                                    id="block_comment"> {{ $buyer->block_comment ?? ''}}</textarea>
                                            </div>
                                         </div>
                                    </div>
